// Generated from base44/functions/fulfillShopifyOrderLine/entry.ts. Do not edit directly.


// base44/functions/fulfillShopifyOrderLine/entry.ts
...
Deno.serve(async (req) => {
  ...
  const {
    shopify_order_ref,
    // local ShopifyOrder ID
    shopify_order_line_ref,
    // local ShopifyOrderLine ID
    sku_ref,
    // local Product ID
    quantity,
    warehouse,
  ...
  const newLineStatus = newFulfilledQty >= line.quantity_ordered ? "fulfilled" : newFulfilledQty > 0 ? "partial" : "unfulfilled";
