    ...
    <div className="max-w-2xl space-y-6">
      ...
      <Card className="p-5">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm font-semibold text-ink">Auto-apply threshold</div>
          ...
          <div className="ml-4 text-2xl font-semibold text-accent">{pct}%</div>
        </div>
        <input
          type="range"
          min={50}
      ...
      <Card className="p-5">
        <label className="flex cursor-pointer items-start gap-3">
          ...
          />
          <span>
            <span className="text-sm font-semibold text-ink">Enable auto-apply</span>
            <p className="mt-0.5 text-sm text-ink-muted">
      ...
      <Card className="p-5">
        <div className="text-sm font-semibold text-ink">What always pauses for approval (high-stakes)</div>
